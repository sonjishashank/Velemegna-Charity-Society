...
function useComposedRefs2(...refs) {
  return React2.useCallback(composeRefs2(...refs), refs);
}
...
var Slot2 = React8.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime4.jsx)(SlotClone2, { ...slotProps, ref: forwardedRef, children: React8.isValidElement(newElement) ? React8.cloneElement(newElement, void 0, newChildren) : null });
  }
...
var Slot3 = React12.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime7.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children: React12.isValidElement(newElement) ? React12.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime7.jsx)(SlotClone3, { ...slotProps, ref: forwardedRef, children });
});
...
var Slot4 = React16.forwardRef((props, forwardedRef) => {
  ...
  if (slottable) {
    ...
    return (0, import_jsx_runtime10.jsx)(SlotClone4, { ...slotProps, ref: forwardedRef, children: React16.isValidElement(newElement) ? React16.cloneElement(newElement, void 0, newChildren) : null });
  }
  return (0, import_jsx_runtime10.jsx)(SlotClone4, { ...slotProps, ref: forwardedRef, children });
});
...
var DialogTrigger = React29.forwardRef(
  (props, forwardedRef) => {
...
var DialogPortal = (props) => {
  ...
  return (0, import_jsx_runtime12.jsx)(PortalProvider, { scope: __scopeDialog, forceMount, children: React29.Children.map(children, (child) => (0, import_jsx_runtime12.jsx)(Presence, { present: forceMount || context.open, children: (0, import_jsx_runtime12.jsx)(Portal, { asChild: true, container, children: child }) })) });
};
DialogPortal.displayName = PORTAL_NAME2;
var OVERLAY_NAME = "DialogOverlay";
var DialogOverlay = React29.forwardRef(
  (props, forwardedRef) => {
...
var DialogOverlayImpl = React29.forwardRef(
  (props, forwardedRef) => {
    ...
    return (
      ...
      (0, import_jsx_runtime12.jsx)(Combination_default, { as: Slot4, allowPinchZoom: true, shards: [context.contentRef], children: (0, import_jsx_runtime12.jsx)(
        Primitive4.div,
        {
          "data-state": getState(context.open),
          ...overlayProps,
...
var DialogContent = React29.forwardRef(
  (props, forwardedRef) => {
...
var DialogContentNonModal = React29.forwardRef(
  (props, forwardedRef) => {
    const context = useDialogContext(CONTENT_NAME, props.__scopeDialog);
...
var DialogContentImpl = React29.forwardRef(
  (props, forwardedRef) => {
...
var DialogTitle = React29.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDialog, ...titleProps } = props;
    const context = useDialogContext(TITLE_NAME, __scopeDialog);
    return (0, import_jsx_runtime12.jsx)(Primitive4.h2, { id: context.titleId, ...titleProps, ref: forwardedRef });
  }
);
DialogTitle.displayName = TITLE_NAME;
var DESCRIPTION_NAME = "DialogDescription";
var DialogDescription = React29.forwardRef(
  (props, forwardedRef) => {
    const { __scopeDialog, ...descriptionProps } = props;
    const context = useDialogContext(DESCRIPTION_NAME, __scopeDialog);
    return (0, import_jsx_runtime12.jsx)(Primitive4.p, { id: context.descriptionId, ...descriptionProps, ref: forwardedRef });
  }
);
DialogDescription.displayName = DESCRIPTION_NAME;
var CLOSE_NAME = "DialogClose";
var DialogClose = React29.forwardRef(
  (props, forwardedRef) => {
